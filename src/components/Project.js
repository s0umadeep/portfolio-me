...
export default function Project(){
    ...
    return(
        <main className="Layout1 min-h-screen p-12">
            ...
            to={{opacity:1}}
                ...
                {props=>(
                    <div style={props}>
                        <section className ="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12">
                    
                    
                    {projectData && projectData.map((project,index)=>(
                    
                    <article className="relative rounded-lg shadow-xl Project-Container p-16">
